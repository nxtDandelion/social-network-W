    ...
    return (
        <div id={userId} className="flex cursor-pointer">
            ...
            <div className="flex flex-col">
                <p onClick={navigateTo} className={`${component === "post" ? "text-white" :"text-black"} text-2xl`}>
                    {userName}
                </p>
                <a onClick={navigateTo} className={`${component === "post" ? "text-[#C0C0C0]" :"text-black text-opacity-75"} text-sm`}>
                    {userTag}
                </a>
