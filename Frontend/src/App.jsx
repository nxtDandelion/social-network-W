...
// Новый компонент для защиты маршрута регистрации
const ProtectedRegistrationRoute = ({ children }) => {
    const { auth } = useContext(AuthContext);

    // Если пользователь уже авторизован, перенаправляем на главную
    if (auth) {
        console.log("Пользователь уже авторизован, доступ к регистрации запрещен");
                        ...
                        <TokenValidator>
                            <div className="relative flex justify-center w-[62rem] min-h-screen">
                                ...
                                <Routes>
                                    ...
                                    />
                                    {/* Обновленный маршрут регистрации с защитой */}
                                    <Route
                                        path="/registration"
                                        element={
